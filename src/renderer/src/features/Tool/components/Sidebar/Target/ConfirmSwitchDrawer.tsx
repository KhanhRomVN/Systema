    ...
    <>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-50 bg-dialog-background border-t border-divider rounded-t-2xl shadow-2xl flex flex-col animate-in slide-in-from-bottom duration-300">
          ...
          <div className="bg-red-500/5 border border-red-500/20 rounded-xl p-4">
            ...
            <ul className="space-y-2 text-sm text-text-secondary">
              ...
              <li className="flex items-center gap-2">
                {' '}
                <Square className="w-3.5 h-3.5 text-red-400" /> Stop the current tracking
                session{' '}
              </li>{' '}
              <li className="flex items-center gap-2">
                {' '}
                <Square className="w-3.5 h-3.5 text-red-400" /> Clear all captured requests{' '}
              </li>{' '}
              <li className="flex items-center gap-2">
                {' '}
                <Square className="w-3.5 h-3.5 text-red-400" /> Close any associated
                browser/application{' '}
              </li>{' '}
            </ul>{' '}
          </div>{' '}
        ...
        <div className="px-5 py-4 border-t border-divider flex justify-end gap-3 shrink-0">
          ...
          >
            {' '}
            <Square className="w-3.5 h-3.5 fill-current" /> Stop & Switch{' '}
          </button>{' '}
        </div>{' '}
      </div>{' '}
    </>
