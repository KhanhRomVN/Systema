...
export function ChatPanel({
  ...
  return (
    <div className="relative flex flex-col h-full bg-table-bodyBg border-l border-border transition-all duration-300">
      <ChatHeader
        sessionId={sessionId}
        title={title}
        provider={provider}
      ...
      <div className="border-t border-border bg-table-bodyBg">
        <ChatInputArea
          input={input}
          setInput={setInput}
          onSend={() => handleSend()}
