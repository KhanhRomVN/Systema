...
export function RequestDetails({
  ...
  const tabs = [
    ...
    },
    {
      ...
      colors: {
        ...
        activeAction: 'bg-purple-500/20 text-purple-500',
      },
    },
    {
      id: 'media',
  ...
  const isFullPanel = activeTab === 'wasm' || activeTab === 'media' || activeTab === 'trace';
    ...
    <div className="flex-1 overflow-hidden h-full" onContextMenu={handleContextMenu}>
      {!request ? (
        ...
        <div className="h-full w-full">
          {activeTab === 'wasm' && <WasmPanel requests={requests} onClose={() => setActiveTab('headers')} />}
          {activeTab === 'media' && <MediaPanel requests={requests} onClose={() => setActiveTab('headers')} />}
          {activeTab === 'trace' && (
            <TracePanel
              request={request}
              requests={requests}
