...
const SettingsPanel: React.FC<SettingsPanelProps> = ({ isOpen, onClose }) => {
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Quản lý rules cho AI assistant
            </p>
          </div>

          {/* Claude CLI Code Card */}
          <div
            style={{
              padding: "var(--spacing-md)",
              backgroundColor: "var(--primary-bg)",
            ...
            onClick={() => setCurrentView("claude-cli")}
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = "var(--hover-bg)";
              e.currentTarget.style.borderColor = "var(--accent-text)";
            }}
          ...
          >
            ...
            >
              Cấu hình backend URL cho Claude CLI service
            </p>
          </div>
          ...
          >
            ...
            >
              Cấu hình cơ chế sao lưu Checkpoints
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <>
      ...
      {currentView === "rules" && <RulePanel />}
      {currentView === "claude-cli" && (
        <ClaudeCliPanel onBack={() => setCurrentView("main")} />
      )}
      {currentView === "checkpoints" && (
        <CheckpointsPanel onBack={() => setCurrentView("main")} />
      )}
    </>
  );
};
