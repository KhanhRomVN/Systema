        ...
        const handleMessage = (event: MessageEvent) => {
          ...
          if (
            ...
            if (message.status === "fuzzy" && message.foundBlock) {
              ...
              console.log("Search Block:", message.searchBlock);
              console.log("Found Block:", message.foundBlock);
              console.log(
                `Diff: ${searchLines} lines requested vs ${foundLines} lines found`
              );
              console.groupEnd();
            }
        ...
        >
          ...
          <div
            style={{
              ...
              padding: "6px 10px",
              borderBottom: `1px solid ${toolColor}20`,
              backgroundColor: `${toolColor}05`, // Slight tint for header
            }}
          >
            {/* Label */}
            <div
